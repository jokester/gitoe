  ...
  GitoeChange = (function() {
    ...
    GitoeChange.html = {
      ...
      pretty_abs_time: function(change) {
        return this.span(moment.unix(change.committer.time).format(), "git_abs_time");
      },
      ...
      p_with_time: function(change, elems) {
        return this.p(__slice.call(elems).concat([this.span(" at ")], [this.pretty_abs_time(change)], [this.span(" / ")], [this.pretty_relative_time(change)]));
      },
      p: function(elements) {
        var e, ret, _i, _len;
    ...
    GitoeChange.message_rules = {
      ...
      actions: {
        ...
        commit: function(matched, change) {
          return this.li([this.p_with_time(change, [this.git_command("git commit")]), this.span(": move "), this.ref(this.ref_fullname(change)), this.span(" from "), this.sha1_commit(change.oid_old), this.span(" to "), this.sha1_commit(change.oid_new)]);
        },
